...
| Model ids                      | `model\_ids.csv`                                                                                                                                       | List of ids for each model, with the model architecture and training parameters. Useful for identifying models when saving metrics in csv files (cf. **Metrics** row)                                                                                                                                                                                                                                                                                                                                                                                                                                                   | models_tested/<br>*model_name*/csv/                  |
| Models                         | `model\_{id}.h5`                                                                                                                                       | Best model with a given set of hyperparameters                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | models_tested/<br>*model_name/*<br>models/           |
| History                        | `history_{id}.pkl`                                                                                                                                     | Model training history                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | models_tested/<br>*model_name/*<br>history/          |
...
| Predicted labels from test set | `pred_raw_{id}.pkl` <br> `pred_scores_all_{id}.pkl` <br> `pred_scores_coa_{id}.pkl` <br> `pred_classes_pres_{id}.pkl` <br> `pred_classes_dom_{id}.pkl` | Files generated with `--save_predictions` argument. <br><br> The predicted presence scores or class. **pred_raw** gives the raw presence scores predicted by the model. For the rest, cf. description above done for "True labels from test set".                                                                                                                                                                                                                                                                                                                                                                       | models_tested/<br>*model_name/*<br>predictions/      |
| Confusion matrix               | `conf_matrix_{id}`<br>`\_t\_{thres}.pkl`                                                                                                               | File generated with `--save_confusion_matrix` argument.<br><br> Multilabel confusion matrix based on the presence/absence of each emotion with a presence score threshold *thres*                                                                                                                                                                                                                                                                                                                                                                                                                                       | models_tested/<br>*model_name/*<br>confusion_matrix/ |
